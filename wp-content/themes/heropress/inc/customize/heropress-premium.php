		...
		?>
			<div class="premium_info">
				<ul>
					...
					<li><a href="https://speciatheme.com/heropress-premium/" class="btn-green"><i class="dashicons dashicons-visibility"></i><?php _e( 'View Details','heropress' ); ?> </a></li>
					...
					<li><a href="https://speciatheme.com/themes/" class="btn-green"><i class="dashicons dashicons-visibility"></i><?php _e( 'Our Themes','heropress' ); ?> </a></li>
			...
			<div>
				<ul>
					...
					<li><a href="https://specia.ticksy.com/submit/#100012426" target="_blank"><img src="<?php echo get_stylesheet_directory_uri(); ?>/images/support.png"></a></li>
