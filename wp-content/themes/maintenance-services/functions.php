...
function maintenance_services_widgets_init() { 	
	register_sidebar( array(
		'name'          => esc_html__( 'Blog Sidebar', 'maintenance-services' ),
		'description'   => esc_html__( 'Appears on blog page sidebar', 'maintenance-services' ),
		'id'            => 'sidebar-1',
		'before_widget' => '',		
...
define('MAINTENANCE_SERVICES_SKTTHEMES_URL','https://www.sktthemes.net/','maintenance-services');
define('MAINTENANCE_SERVICES_SKTTHEMES_PRO_THEME_URL','https://www.sktthemes.net/shop/home-maintenance-wordpress-theme/','maintenance-services');
define('MAINTENANCE_SERVICES_SKTTHEMES_FREE_THEME_URL','https://www.sktthemes.net/shop/free-renovation-wordpress-theme','maintenance-services');
...
define('MAINTENANCE_SERVICES_SKTTHEMES_THEMES','https://www.sktthemes.net/themes/','maintenance-services');
/**
